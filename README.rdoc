...
1. Copy the "redmine_scrumdashboard" folder to "\vendor\plugins" 
(Example:  c:\ruby\redmine-0.8.0\vendor\plugins)
...
Q: How do I add language support?
 In the "redmine_scrumdashboard\lang" folder all the .yml language files are located. Make a copy of an existing file and translate the options. 
